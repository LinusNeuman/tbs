...
void Options::Initialize()
{
	...
	SliderArgsSFX.myPositionArguments.mySliderPosition = { 0.5f - (0.171875f / 2), myPosition.y + 0.11f };
	SliderArgsMusic.myPositionArguments.mySliderPosition = { 0.5f - (0.171875f / 2), myPosition.y - 0.040f };
