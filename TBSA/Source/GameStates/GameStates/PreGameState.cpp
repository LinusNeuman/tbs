...
PreGameState::PreGameState() : myTextBox({ 1920.f / 2 - 250, 250.f }, { 1920.f, 1080.f }, "Text/calibril.ttf_sdf", eLinewrappingMode::Char)
{
	...
	myTextBox.AddText("");
	myTextBox.AddText("");
	myTextBox.AddText("Press Enter to continue...");
